  ...
  function componentDidMount() {
    ...
    axios
      .post("https://apisendemail2.herokuapp.com/send", {
        ...
        from: "Formulario Enflor & Garden Fair <form@enflor.com.br>",
        to: [emailRemente, "montagemenflorgf@rbbeventos.com.br"],
        hmtlContent: body,
      })
    ...
    <div className="container">
      ...
      <div className="filds">
        ...
        <div className="textArea">
          ...
          <textarea
            onChange={(ev) => setPrincipaisProdutos(ev.target.value)}
            maxlength="200"
          >
            {principaisProdutos}
          </textarea>
